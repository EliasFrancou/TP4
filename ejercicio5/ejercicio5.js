...
const paqueteTamañoOrden = paquetesDatos.filter(paquete => paquete.tamaño > 1000).sort((a, b) => b.prioridad - a.prioridad);
console.log("Paquetes filtrados y ordenados por prioridad: ", paqueteTamañoOrden)